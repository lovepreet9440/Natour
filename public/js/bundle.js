...
var formElemnt = document.querySelector('.form');
var logoutBtn = document.querySelector('.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
console.log(userDataForm); // const locations = JSON.parse(mapBox.dataset.locations)
// if (mapBox) displayMap()

if (formElemnt) formElemnt.addEventListener('submit', function (e) {
  e.preventDefault();
